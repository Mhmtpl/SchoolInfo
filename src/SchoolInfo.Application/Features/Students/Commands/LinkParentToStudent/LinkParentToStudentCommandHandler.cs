...
public class LinkParentToStudentCommandHandler : IRequestHandler<LinkParentToStudentCommand>
{
    private readonly IAppDbContext _dbContext;
    private readonly ICurrentUserService _currentUserService;

    public LinkParentToStudentCommandHandler(IAppDbContext dbContext, ICurrentUserService currentUserService)
    {
        _dbContext = dbContext;
        _currentUserService = currentUserService;
    }

    public async Task Handle(LinkParentToStudentCommand request, CancellationToken cancellationToken)
    {
